...
module.exports.run = async function({ api, event, args }) {
  ...
  if (!finalPrompt && !event.messageReply?.attachments?.[0]?.url) {
    return api.sendMessage("🟢𝗞𝗘𝗜𝗝𝗢 𝗔.𝗜 👋𝗛𝗲𝗹𝗹𝗼 𝗜'𝗺 𝗞𝗘𝗜𝗝𝗢 𝗔.𝗜 𝗪𝗛𝗔𝗧 𝗖𝗔𝗡 𝗜 𝗛𝗘𝗟𝗣 𝗬𝗢𝗨 𝗧𝗢𝗗𝗔𝗬?
│𝗛𝗨𝗬 𝗪𝗔𝗚 𝗞𝗔𝗡𝗚 𝗠𝗔𝗛𝗜𝗬𝗔 𝗦𝗔𝗞𝗜𝗡 𝗔𝗛 𝗡𝗔𝗡𝗗𝗜𝗧𝗢 𝗟𝗔𝗡𝗚 𝗔𝗞𝗢 𝗣𝗔𝗥𝗔 𝗧𝗨𝗠𝗨𝗟𝗢𝗡𝗚!", threadID, messageID);
  }
